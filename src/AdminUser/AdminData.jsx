import { ACCESS_MODULES, getFullAccessPermissions } from "../config/accessControl";
...
const adminRoles = [
  "System Admin",
  ...Array.from(new Set(admin.map((entry) => entry.role))),
];

export { ACCESS_MODULES, admin, adminRoles };
